...
## Immediate Roadmap
1. **Loading Bar:** [NEEDS_QA] Implementation of a progress simulation before entering the city.
2. **Login Redirect:** [TODO_CODE] Add functionality to route people to the startpage, that aren't logged in.
